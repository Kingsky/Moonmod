...
public class WorldChunkManagerMoon extends WorldChunkManager
{
    ...
    private float moonTemperature;

    /** The rainfall in the world */
    private float rainfall;

    public WorldChunkManagerMoon(BiomeGenBase par1BiomeGenBase, float par2, float par3)
    {
        this.biomeGenerator = par1BiomeGenBase;
        this.moonTemperature = par2;
        this.rainfall = par3;
    }
    ...
    public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
    {
        ...
        Arrays.fill(par1ArrayOfFloat, 0, par4 * par5, this.moonTemperature);
